# lavanda-transmission-serverless
## INFO
Esta función lambda está escrita en NodeJS y tiene como función leer todos los mensajes de la cola transmission de SQS. Una vez tiene la información se conecta a transmission.lavandadelpatio.es via RPC y añade el torrent. Si el torrent falla por problema de transmission se envia un mensaje a través de SNS al telegram de luiscajl. 
